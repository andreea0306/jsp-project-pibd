...
<html>
	<% String requestS = request.getParameter("req");
		if(requestS.equals("Modifica Colectie")){
    ...
    <div class="container">
      <div class="row">
        <div class="p-5 col-lg-6 col-10 mx-auto border">
          <h1 class="mb-4">Modifica colectii</h1>
    <form action="m2_colectiiTEST.jsp" method="post">
      <div class="form-group"> <input type="text" class="form-control" name="idcolectie" value="<%= aux%>" readonly> </div>
           <td> 
                        <SELECT NAME="idmuzician" class="form-control bg-light text-body dropdown">
                            <%
                                while (rs1.next()) {
                    ...
                    <tr>
                    <td> 
                        <SELECT NAME="idstilmuzical" class="form-control bg-light text-body dropdown">
                            <%
                                while (rs2.next()) {
            ...
            <div class="form-group"> <input type="text" class="form-control" name="name" value="<%= NumeColectie%>"></div>
            <div class="form-group"> <input type="text" class="form-control" name="anaparitie" value="<%= AnAparitie%>"></div>
        ...
        <% }
        	jb.connect();
        	jb.stergeDateTabela(s, "colectii", "idcolectie");
        	jb.disconnect();
        
        %>
		<jsp:forward page="tabela_colectiiTEST.jsp"/>
