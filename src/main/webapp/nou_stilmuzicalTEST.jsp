...
<body>
      ...
      <div class="py-5 text-center text-white">
        <div class="container">
          <div class="row">
            <div class="p-5 col-lg-6 col-10 mx-auto border">
              <h1 class="mb-4">Adauga Stil Muzical</h1>
               <%
        ...
        %>
  		...
  		<form action="tabela_stilurimuzicaleTEST.jsp" method="post">
  		<button class="btn btn-secondary" href="tebela_stilurimuzicaleTEST.jsp">Inapoi</button>
  		</form>
  		
        <%
        } else {
        %>
              <form action="nou_stilmuzicalTEST.jsp" method="post">
                <div class="form-group"> <input type="text" name="stilmuzical" class="form-control" placeholder="StilMuzical" id="form13" required="required"> </div>
