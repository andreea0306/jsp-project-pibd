...
<body>
  ...
  <div>
  <h1 class="mb-4" style="color:#9999ff">Datele au fost modificate cu succes!</h1>
...
<%
            jb.connect();
            int aux = java.lang.Integer.parseInt(request.getParameter("idstilmuzical"));
            String Nume = request.getParameter("stilmuzical");

            String[] valori = {Nume};
            String[] campuri = {"stilmuzical"};
            jb.modificaTabela("stilurimuzicale", "idstilmuzical", aux, campuri, valori);
            jb.disconnect();
        %>
