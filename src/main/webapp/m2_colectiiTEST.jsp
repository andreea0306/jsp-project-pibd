...
<body>
  ...
  <form action="tabela_colectiiTEST.jsp" method="post">
    ...
    <%
            jb.connect();
            int aux = java.lang.Integer.parseInt(request.getParameter("idcolectie"));
            String idmuzician = request.getParameter("idmuzician");
            String idstilmuzical = request.getParameter("idstilmuzical");
            String NumeColectie = request.getParameter("name");
            String AnAparitie = request.getParameter("anaparitie");

            String[] valori = {idmuzician, idstilmuzical, NumeColectie, AnAparitie};
            String[] campuri = {"idmuzician", "idstilmuzical", "name", "anaparitie"};
            jb.modificaTabela("colectii", "idcolectie", aux, campuri, valori);
            jb.disconnect();
        %>
