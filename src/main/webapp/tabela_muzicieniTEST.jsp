...
<body>
  ...
  <form action="handler_muzicieniTEST.jsp" method="post">
    ...
    <table class="styled-table">
      <tbody>
        <tr>
          ...
          <th><b style="color:#9999ff"> Nume:</b></th>
          <th><b style="color:#9999ff">Prenume:</b></th>
          <th><b style="color:#9999ff">Data nasterii:</b></th>
      ...
      <%
				...
				<td><b style="color:#9999ff"><%= rs.getString("nume")%></b>></td>
				<td><b style="color:#9999ff"><%= rs.getString("prenume")%></b></td>
				<td><b style="color:#9999ff"><%= rs.getString("datanasterii")%></b></td>
    ...
    <input class="btn btn-secondary" type="submit" name = "req" value="Modifica Muzician">
    <input class="btn btn-secondary" type="submit" name = "req" value="Sterge Muzician">
    <a class="btn btn-secondary" href="nou_muzicianTEST.jsp">Adauga Muzician</a>
    </div>
