...
.custom-range {
  ...
  .custom-range:focus {
    ...
    .custom-range:focus::-webkit-slider-thumb {
      box-shadow: 0 0 0 1px #222, 0 0 0 0.2rem rgba(18, 187, 173, 0.25); }
...
.nav-tabs {
  ...
  .nav-tabs .nav-item.show .nav-link {
    color: #495057;
    background-color: #222;
    border-color: #dee2e6 #dee2e6 #222; }
...
<body>
  <nav class="navbar navbar-expand-lg bg-dark navbar-dark" style="	box-shadow: 0px 0px 4px  black;">
    <div class="container"> <button class="navbar-toggler navbar-toggler-right border-0 p-0" type="button" data-toggle="collapse" data-target="#navbar8" style="">
      ...
      <div class="collapse navbar-collapse" id="navbar8">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item"> <a class="nav-link" href="blank.html">Home</a> </li>
        </ul>
  ...
  <form action="handler_colectiiTEST.jsp" method="post">
     
    <table class="styled-table">
      <tbody>
        <tr>
          <th><b style="color:#9999ff">Mark:</b></th>
          <th><b style="color:#9999ff">idColectie:</b></th>
          <th><b style="color:#9999ff">IdMuzician:</b></th>
          <th><b style="color:#9999ff">NumeMuzician:</b></th>
          <th><b style="color:#9999ff">PrenumeMuzician:</b></th>
          <th><b style="color:#9999ff">Trupa:</b></th>
          <th><b style="color:#9999ff">IdStilMuzical:</b></th>
          <th><b style="color:#9999ff">StilMuzical:</b></th>
          <th><b style="color:#9999ff">NumeColectie:</b></th>
          <th><b style="color:#9999ff">AnAparitie:</b></th>
        </tr>
      </tbody>
      <%
                    jb.connect();
				...
				<td><b style="color:#9999ff"><%= x%></b></td>
				<td><b style="color:#9999ff"><%= rs.getString("IDmuzician")%></b></td>
				<td><b style="color:#9999ff"><%= rs.getString("NumeMuzician")%></b></td>
				<td><b style="color:#9999ff"><%= rs.getString("PrenumeMuzician")%></b></td>
				<td><b style="color:#9999ff"><%= rs.getString("Trupa")%></b></td>
				<td><b style="color:#9999ff"><%= rs.getString("IDstilMuzical")%></b></td>
				<td><b style="color:#9999ff"><%= rs.getString("StilMuzical")%></b></td>
				<td><b style="color:#9999ff"><%= rs.getString("NumeColectie")%></b></td>
				<td><b style="color:#9999ff"><%= rs.getString("AnAparitie")%></b></td>
				<%
                        }
                    %>
			</tr>   
    ...
    <input class="btn btn-secondary" type="submit" name = "req" value="Modifica Colectie">
    <input class="btn btn-secondary" type="submit" name = "req" value="Sterge Colectie">
    <a class="btn btn-secondary" href="nou_colectiiTEST.jsp">Adauga Colectie</a>
    </div>
