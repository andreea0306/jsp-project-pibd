  ...
  <%
   ...
   <div class="py-5 text-center text-white">
    <div class="container">
      <div class="row">
        <div class="p-5 col-lg-6 col-10 mx-auto border">
          <h1 class="mb-4">Adauga Coloctie </h1>
          <form action="nou_colectiiTEST.jsp" method = "post">
           <div class="form-group text-left"> <label><b><i>Selectati muzicianul:</i></b></label>
           	<td> 
				  ...
				  <div class="form-group text-left"> <label><b><i>Selectati stilul muzical:</i></b></label> 
				  <td>
            ...
            <div class="form-group"> <input type="text" class="form-control" name="name" placeholder="Nume colectie" id="form14"> </div>
            <div class="form-group"> <input type="text" class="form-control" name="anaparitie" placeholder="An aparitie" id="form15"></div>
