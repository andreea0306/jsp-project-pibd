...
<body>
  ...
  <form action="handler_stilurimuzicale.jsp" method="post">
    ...
    <table class="styled-table">
      <tbody>
        <tr>
          ...
          <th><b style="color:#9999ff"> Nume Stil Muzical:</b></th>
        </tr>
      </tbody>
      <%
                    jb.connect();
    ...
    <input class="btn btn-secondary" type="submit" name = "req" value="Modifica Stil Muzical">
    <input class="btn btn-secondary" type="submit" name = "req" value="Sterge Stil Muzical">
    <a class="btn btn-secondary" href="nou_stilmuzicalTEST.jsp">Adauga Stil Muzical</a>
    </div>
