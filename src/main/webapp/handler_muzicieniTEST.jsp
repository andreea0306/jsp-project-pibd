...
<% String requestS = request.getParameter("req");
		if(requestS.equals("Modifica Muzician")){
...
<%
            ...
            jb.disconnect();
        %>
    <form action="m2_muzicieniTEST.jsp" method="post">
             <div class="py-5 text-center text-white">
    <div class="container">
      <div class="row">
        <div class="p-5 col-lg-6 col-10 mx-auto border">
          <h1 class="mb-4">Modifica Muzician</h1>
           <div class="form-group"> <input type="text" class="form-control" name="idmuzician" value="<%= aux%>" readonly> </div>
            <div class="form-group"> <input type="text" class="form-control" name="nume" value="<%= Nume%>" > </div>
            <div class="form-group"> <input type="text" class="form-control" name="prenume" value="<%= Prenume%>"> </div>
            <div class="form-group"> <input type="date" class="form-control" name="datanasterii" value="<%= DataNasterii%>"> </div>
            <div class="form-group"> <input type="text" class="form-control" name="trupa" value="<%= Trupa%>"></div>
        ...
        <%} else if(requestS.equals("Sterge Muzician")){
        	String[] s = null;
        	try{
        		s = request.getParameterValues("primarykey");
        ...
        %>
		<jsp:forward page="tabela_muzicieniTEST.jsp"/>
