...
<meta charset="utf-8">
  ...
  <link rel="stylesheet" href="/home/andreea/Pingendo/test/default/nou_muzician.css">
</head>
<style>
/*!
...
<body>
      ...
      <div class="py-5 text-center text-white">
        <div class="container">
          <div class="row">
            <div class="p-5 col-lg-6 col-10 mx-auto border">
              <h1 class="mb-4">Adauga Muzician</h1>
               <%
        ...
        %>
  		...
  		<button class="btn btn-secondary" href="tebela_muzicieniTEST.jsp">Inapoi</button>
  		</form>
  		
        <%
        } else {
        %>
              <form action="nou_muzicianTEST.jsp" method="post">
                <div class="form-group"> <input type="text" name="nume" class="form-control" placeholder="Nume" id="form13" required="required"> </div>
                <div class="form-group"> <input type="text" name="prenume" class="form-control" placeholder="Prenume" id="form14" required="required"> </div>
                <div class="form-group"> <input type="date" name="datanasterii" class="form-control" placeholder="Data nasterii" id="form15" required="required"> </div>
                <div class="form-group"><input type="text" name="trupa" class="form-control" id="inlineFormInput" placeholder="Trupa"></div>
