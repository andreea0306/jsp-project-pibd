...
<% String requestS = request.getParameter("req");
		if(requestS.equals("Modifica Stil Muzical")){
...
<%
            ...
            jb.disconnect();
        %>
    <form action="m2_stilurimuzicaleTEST.jsp" method="post">
             <div class="py-5 text-center text-white">
    <div class="container">
      <div class="row">
        <div class="p-5 col-lg-6 col-10 mx-auto border">
          <h1 class="mb-4">Modifica Stil Muzical</h1>
           <div class="form-group"> <input type="text" class="form-control" name="idstilmuzical" value="<%= aux%>" readonly> </div>
            <div class="form-group"> <input type="text" class="form-control" name="stilmuzical" value="<%= stilmuzical%>" > </div>
        ...
        <%} else if(requestS.equals("Sterge Stil Muzical")){
        	String[] s = null;
        	try{
        ...
        <% }
        	jb.connect();
        	jb.stergeDateTabela(s, "stilurimuzicale", "idstilmuzical");
        	jb.disconnect();
        
        %>
		<jsp:forward page="tabela_stilurimuzicaleTEST.jsp"/>
